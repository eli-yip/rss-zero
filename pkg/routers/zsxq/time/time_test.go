	...
	testCases := []testCase{
		{
			...
			time.Date(2023, 9, 14, 21, 51, 50, 943000000, config.C.BJT),
			"2023-09-14T21%3A51%3A50.942%2B0800",
		},
		{
			// equals to zsxq api time str "2023-08-30T19:59:22.593+0800"
			time.Date(2023, 8, 30, 19, 59, 22, 593000000, config.C.BJT),
	...
	testCases := []testCase{
		{
			...
			time.Date(2024, 1, 22, 14, 56, 02, 297000000, config.C.BJT),
		},
		{
			// equals to zsxq api time str "2023-08-30T19:59:22.593+0800"
			"2024-01-22T12:19:44.405+0800",
			time.Date(2024, 1, 22, 12, 19, 44, 405000000, config.C.BJT),
		},
	}
