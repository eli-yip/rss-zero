...
type Imager interface {
	...
	ParseImages(text string, id int, t common.ZhihuContentType, logger *zap.Logger) (result string, err error)
...
func (p *OnlineImageParser) ParseImages(text string, id int, t common.ZhihuContentType, logger *zap.Logger) (result string, err error) {
...
func (p *OfflineImageParser) ParseImages(text string, id int, t common.ZhihuContentType, logger *zap.Logger) (result string, err error) {
	for _, imageLink := range findImageLinks(text) {
