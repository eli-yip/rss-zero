...
| 2026-06-12 | zsxq-config-externalization | [specs/2026-06-12-02-zsxq-config-externalization.md](specs/2026-06-12-02-zsxq-config-externalization.md) | 待写 | SPEC 定稿（4 项分类：作者屏蔽进全局配置；topicIDSkip/业务码/魔法日期提具名常量）。PLAN 待写。注意：项1 需同步现网 config.toml 补 [zsxq] 段 |
